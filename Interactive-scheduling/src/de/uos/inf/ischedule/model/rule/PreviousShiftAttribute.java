...
/**
 * Attribute for previous shift.
 * 
 * @author David Meignan
 */
public class PreviousShiftAttribute extends Attribute<String> {
	 ...
	 */
	private String key = "previous-shift";
	 ...
	 */
	public PreviousShiftAttribute(ShiftSchedulingProblem problem) {
		// Creates the values
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PreviousShiftAttribute other = (PreviousShiftAttribute) obj;
		if (key == null) {
			if (other.key != null)
				return false;
